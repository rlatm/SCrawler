...
Namespace API.XVIDEOS
    Friend Class UserData : Inherits UserDataBase
        ...
        Protected Overrides Sub DownloadDataF(Token As CancellationToken)
            ...
            End If
        End Sub
        Private Sub DownloadUserVideo(Token As CancellationToken)
        ...
        End Sub
        Private Sub DownloadSavedVideos(Token As CancellationToken)
            ...
            End Try
        End Sub
        Private Function GetVideoData(Media As UserMedia, resp As Responser, DownloadUHD As Boolean) As UserMedia
            Try
            ...
            End Try
        End Function
        Friend Function Download(URL As String, resp As Responser, DownloadUHD As Boolean, ID As String)
