...
Namespace API.Xhamster
    Friend NotInheritable Class M3U8
        Private Sub New()
        End Sub
        Private Shared Function ParseFirstM3U8(URL As String, Responser As Responser, UHD As Boolean) As String
            Dim r$, d$
            ...
            Return String.Empty
        End Function
        Private Shared Function ParseSecondM3U8(URL As String, Responser As Responser, Appender As String) As List(Of String)
            Dim r$
            ...
            Return Nothing
        End Function
        Private Shared Function ObtainUrls(URL As String, Responser As Responser, UHD As Boolean) As List(Of String)
            Try
            ...
            End Try
        End Function
        Friend Shared Function Download(Media As UserMedia, Responser As Responser, UHD As Boolean) As SFile
