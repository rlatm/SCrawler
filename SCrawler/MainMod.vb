...
Friend Module MainMod
    ...
    Friend Delegate Sub NotificationEventHandler(Sender As SettingsCLS.NotificationObjects, Message As String)
    ...
    Friend Sub CheckVersion(Force As Boolean)
    ...
    Friend Sub ExecuteCommand(Obj As XMLValueAttribute(Of String, Boolean))
        Try
    ...
    <Extension> Friend Function GetGroupsLabels(Of T As Groups.IGroup)(Groups As IEnumerable(Of T)) As List(Of String)
    ...
    Friend Function GetLviGroupName(Host As SettingsHost, IsCollection As Boolean, IsChannel As Boolean) As ListViewGroup()
    ...
    Friend Function GetLviGroupName(Host As SettingsHost, Temp As Boolean, Fav As Boolean,
    IsCollection As Boolean, IsChannel As Boolean) As String
    ...
    Friend Sub GlobalOpenPath(f As SFile, Optional e As ErrorsDescriber = Nothing)
...
#Region "Standalone video download functions"
    ...
    Friend Function DownloadVideoByURL(URL As String, AskForPath As Boolean, Silent As Boolean) As Boolean
